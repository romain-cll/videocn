  ...
  return (
    <>
      <main className="mx-auto flex max-w-6xl flex-col items-center px-6">
        <section className="flex flex-col items-center gap-6 pt-20 pb-14 text-center md:pt-28">
        ...
        <p className="text-muted-foreground max-w-2xl pb-20 text-center text-sm text-pretty">
