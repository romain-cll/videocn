...
const ROLE_CLASSES: Record<Role, string> = {
  ...
  right: "z-10 translate-x-[28%] translate-y-6 scale-[0.86] opacity-60 hover:opacity-80 max-md:hidden",
  left: "z-10 -translate-x-[28%] translate-y-6 scale-[0.86] opacity-60 hover:opacity-80 max-md:hidden",
};
